    ...
    render() {
        ...
        return (
            <form role="form" style={this.props.style}>
                ...
                <div className="form-group">
                    <div className="row">
                        <a href="javascript:;" className="col-xs-6" onClick={this.onRefreshCaptcha.bind(this)}>
                            <img src={CAPTCHA_URI} style={{height:'2.6rem',width:'auto'}}/>
                        </a>
                ...
                <div className="form-group">
                    <Link to="authSignIn">已有账号，登录</Link>
                </div>
            </form>
        );
    }
